  ...
  return (
    ...
    >
      {!collapsed ? (
          ...
          <div className="h-14 px-4 border-b border-white/[0.06] flex items-center gap-3 shrink-0">
            ...
            <div className="flex items-center gap-1 shrink-0">
              <button
                onClick={handleCopy}
                title="Copy all code"
                className="flex items-center gap-1.5 px-2 py-1.5 text-[11px] font-medium text-slate-400 hover:text-slate-200 hover:bg-white/[0.05] rounded-lg transition-colors duration-150 bg-transparent border-none cursor-pointer"
              >
                <Copy size={15} />
              </button>
            </div>
        ...
        <div className="hidden lg:flex h-full border border-white/[0.06] flex-col items-center py-4 gap-3 shrink-0 bg-[#0d0f14]">
          <button
